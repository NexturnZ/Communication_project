classdef sdruQAMDataDecoder < matlab.System
%#codegen
...
%   Copyright 2012 The MathWorks, Inc.
    ...
    methods
        function obj = sdruQAMDataDecoder(varargin)
...
%             obj.pModulatedHeader = [0.843511987785524 + 0.843511987785524i;...
%                                     0.843511987785524 + 0.843511987785524i;...
%                                     0.843511987785524 - 0.843511987785524i;...
%                                    -0.843511987785524 + 0.843511987785524i;...
%                                     0.843511987785524 - 0.843511987785524i;...
%                                     0.843511987785524 - 0.843511987785524i;...
...
%                                    -0.843511987785524 + 0.843511987785524i];
            ...
            obj.pModulatedHeader = [ -0.9487 + 0.9487i ...
                                     -0.9487 + 0.9487i ...
                                     -0.3162 + 0.3162i ...
                                      0.9487 - 0.9487i ...
                                     -0.3162 + 0.3162i ...
...
%             obj.pQPSKDemodulator = comm.GeneralQAMDemodulator('BitOutput', true);
%             const = [-3-3i, -3-1i, -3+1i, -3+3i,...
%                      -1-3i, -1-1i, -1+1i, -1+3i,...
%                       1-3i,  1-1i,  1+1i,  1+3i,...
%                       3-3i,  3-1i,  3+1i,  3+3i];
%             const = const/sqrt(norm(const));
%             obj.pQPSKDemodulator.Constellation = const;
