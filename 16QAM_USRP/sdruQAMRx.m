classdef sdruQAMRx < matlab.System
%#codegen
...
%   Copyright 2012-2014 The MathWorks, Inc.    
    ...
    methods
        function obj = sdruQAMRx(varargin)
    ...
    methods (Access=protected)
        function setupImpl(obj, ~)
            ...
            obj.pCoarseFreqCompensator = QAMCoarseFrequencyCompensator(...
            ...
            obj.pDataDecod = sdruQAMDataDecoder('FrameSize', obj.FrameSize, ...
