function SimParams = sdruQAMtransmitter_init(platform)
...
SimParams.FrameSize = 50; % Number of modulated symbols per frame

% Tx parameters
SimParams.BarkerLength = 13; % Number of Barker code symbols
SimParams.DataLength = SimParams.FrameSize*4 - SimParams.BarkerLength*4; % Number of data payload bits per frame
...
SimParams.USRPCenterFrequency = 2.9e9;
