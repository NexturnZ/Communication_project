classdef sdru4QAMDataDecoder < matlab.System
%#codegen
...
%   Copyright 2012 The MathWorks, Inc.
    ...
    methods
        function obj = sdru4QAMDataDecoder(varargin)
    ...
    methods (Access=protected)
        function setupImpl(obj, ~)
            ...
            header = header(:);
            obj.pModulator  = comm.RectangularQAMModulator('ModulationOrder',4,'BitInput',true);  %%  
            obj.pModulatedHeader = step(obj.pModulator, header); % Modulate the header
            obj.pCorrelator = dsp.Crosscorrelator;
            obj.pQPSKDemodulator = comm.RectangularQAMDemodulator('ModulationOrder',4,'BitOutput',true);
